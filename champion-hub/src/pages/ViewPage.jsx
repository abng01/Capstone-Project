...
export default function ViewPage() {
    ...
    const textStyle = {
        color: "white", textAlign: "left", py: 1, pl: 2, fontSize: 18
    }
    ...
    return(
        <Container maxWidth={false} sx={{ px: { xs: 2, sm: 4, md: 8, p: { xs: 2, md: 4 } } }}>
            <Card sx={{ backgroundColor: "#3F4555", width: "100%", maxWidth: 1200, mx: "auto",  }}>
                <CardContent sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                        ...
                        <Typography sx={textStyle}>
                            <span style={spanStyle}>Abilities: </span>{champion.lore}
                        </Typography>                        
                    </Box>
                </CardContent>
            </Card>
